  ...
  cookies: {
    sessionToken: {
      ...
      options: {
        ...
        domain: VERCEL_DEPLOYMENT ? (process.env.NEXT_PUBLIC_BASE_URL ? `.${new URL(process.env.NEXT_PUBLIC_BASE_URL).hostname}` : undefined) : undefined,        secure: VERCEL_DEPLOYMENT,
      },
    },
  },
  callbacks: {
